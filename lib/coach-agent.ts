...
/**
 * Run the Socratic coach with optional tool (query_user_history). When userId is provided and DB is available,
 * the model can call the tool to retrieve past evidence; we run up to MAX_TOOL_ROUNDS then return the final reply.
 */
